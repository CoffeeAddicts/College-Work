...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // Functions.Add(name, "sfsdsesfdsfs", playCount);
        // Functions.Add(name, "sfsdsfdsadfs", playCount);
        // Functions.Add(name, artist, playCount);
        // Functions.Add(name, "sfsfsfdsfdfs", playCount);
        // Functions.Update(name, artist,"2");
